...
type GetBranchBrandSaleSumFunc func(branchId int32, brandId int32, period entities.Period) (int64, error)

func NewGetBranchBrandSaleSumFunc(ctxt context.Context, store generated.SaleStore) GetBranchBrandSaleSumFunc {
	return func(branchId int32, brandId int32, period entities.Period) (int64, error) {
