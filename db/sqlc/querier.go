...
type Querier interface {
	...
	AddGoodToBrand(ctx context.Context, arg AddGoodToBrandParams) error
	AddGoodToSale(ctx context.Context, arg AddGoodToSaleParams) error
	...
	CreateGood(ctx context.Context, arg CreateGoodParams) (int32, error)
