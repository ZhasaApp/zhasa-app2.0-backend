...
func (q *Queries) GetSalesManagerYearStatistic(ctx context.Context, arg GetSalesManagerYearStatisticParams) ([]GetSalesManagerYearStatisticRow, error) {
	rows, err := q.db.QueryContext(ctx, getSalesManagerYearStatistic, arg.SalesManagerID, arg.SaleDate)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
